...
### Commands
kubectl create configmap swiggy-config --from-literal=CITY=Hyderabad --from-literal=DB_URL=swiggy-database.com
...
### Commands
kubectl create secret generic swiggy-secret --from-literal=DB_PASSWORD=swiggy123
kubectl get secrets
